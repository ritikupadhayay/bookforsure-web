...
<DIV ID="ADDBOOK">
<fieldset>
<FORM  method="POST" action="postclassnotes.php" enctype="multipart/form-data"> <BR /><div id="TEXT1">&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp 
...
&nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp <B>2. NOTES NAME:&nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp &nbsp </B><INPUT TYPE="TEXT" NAME="pname"  size=45>  
 <BR /><br /> <br /> 
...
<br/>
<b><div ID="ABOUTBOOK"> 5. ABOUT BOOK</div></B>
...
function list(array_list)
{
    ...
    $(array_list).each(function (i) { //populate child options 
        $("#child_selection").append("<option value=\""+array_list[i].value+"\">"+array_list[i].display+"</option>");
			  ...
			  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <b><DIV ID="ADDRESS">12. ADDRESS:</DIV>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp 
&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <TEXTAREA name="saddr" rows="7" cols="40" placeholder="PLEASE TYPE YOUR ADDRESS HERE"></TEXTAREA></b><BR /><BR /><BR/>
 <input type="submit" name="submit" id="submit" value="Becho Notes" style="POSITION:ABSOLUTE; left:270px; width:130px; height:50px; font-size:15pt; background-color:#FFFF00; "><BR /><BR />
