...
<DIV ID="ADDBOOK">
<fieldset>
<FORM  method="POST" action="postmagazaine.php" enctype="multipart/form-data"> <BR /><div id="TEXT1">&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp 
...
&nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp <B>2. MAGAZINE NAME:&nbsp &nbsp &nbsp &nbsp </B><INPUT TYPE="TEXT" NAME="pname"  size=45>  
 <BR /><br /> <br /> 
...
&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <B>7.UPLOAD PHOTO: </B>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <input type="hidden" name="MAX_FILE_SIZE" value="2000000">
 ...
 <BR>
 &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <B>11. EMAIL ID:</B> &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <?php session_start(); $loginemail=  $_SESSION["email"]; echo "$loginemail";?><BR /><BR /><BR />
 <br>
 &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <b>12. SELECT COLLEGE/SCHOOL:</b>&nbsp &nbsp &nbsp &nbsp &nbsp <SELECT NAME="TYPE">
...
function list(array_list)
{
    ...
    $(array_list).each(function (i) { //populate child options 
        $("#child_selection").append("<option value=\""+array_list[i].value+"\">"+array_list[i].display+"</option>");
			  ...
			  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <b><DIV ID="ADDRESS">14. ADDRESS:</DIV>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp 
&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <TEXTAREA name="saddr" rows="7" cols="40" placeholder="PLEASE TYPE YOUR ADDRESS HERE"></TEXTAREA></b><BR /><BR /><BR/>
 <input type="submit" name="submit" id="submit" value="Becho Magazine" style="POSITION:ABSOLUTE; left:270px; width:170px; height:50px; font-size:15pt; background-color:#FFFF00; "><BR /><BR />
